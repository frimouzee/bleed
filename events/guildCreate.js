...
client.on("guildCreate", guild => {
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .addField(`**Invite Root**`, `[Invite Here](https://discord.com/api/oauth2/authorize?client_id=1499792921401098270&permissions=8&scope=bot)`, true)
    .addField(`**Upvote Root**`, `[Upvote Here](https://top.gg/bot/1499792921401098270)`, true)
